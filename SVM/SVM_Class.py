...
# 8. Funció per a la matriu de confusió amb números i percentatges
def plot_confusion_matrix(y_true, y_pred, labels):
    ...
    sns.heatmap(cm_percent, annot=annotations, fmt="", cmap="Blues", xticklabels=labels, yticklabels=labels)
    plt.title("Matriu de Confusió (%) i Nombres Reals")
